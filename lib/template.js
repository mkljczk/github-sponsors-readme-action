...
const getResponseData = (response, organization) => { var _a, _b; return organization ? (_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.organization : (_b = response === null || response === void 0 ? void 0 : response.data) === null || _b === void 0 ? void 0 : _b.viewer; };
/**
...
function getSponsors(action) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const tokens = (0, util_1.parseTokens)(action.token);
            (0, core_1.info)(`Fetching data from the GitHub API for ${tokens.length} account${tokens.length === 1 ? '' : 's'} as ${action.organization ? 'Organization' : 'User'}… ⚽`);
            const query = `query { 
      ${action.organization
        ...
        sponsorshipsAsMaintainer(first: 100, orderBy: {field: CREATED_AT, direction: ASC}, includePrivate: ${action.includePrivate}, activeOnly: ${action.activeOnly}) {
          ...
          nodes {
            ...
            const responses = yield Promise.all(tokens.map((token) => __awaiter(this, void 0, void 0, function* () {
            ...
            const mergedNodes = responses.flatMap(response => {
                ...
                return ((_a = responseData === null || responseData === void 0 ? void 0 : responseData.sponsorshipsAsMaintainer) === null || _a === void 0 ? void 0 : _a.nodes) || [];
            });
    ...
    if (sponsorshipsAsMaintainer) {
        ...
        const mergedSponsors = filteredSponsors.reduce((merged, sponsor, index) => {
            const sponsorLogin = sponsor.sponsorEntity.login
                ...
                : '';
            const key = !(0, util_1.isNullOrUndefined)(sponsorLogin)
                ? sponsorLogin
                : `private-${index}`;
        ...
        const orderedSponsors = [...mergedSponsors.values()]
            ...
            .map(({ sponsor, sponsoredAccountsCount }) => (Object.assign(Object.assign({}, sponsor), { sponsoredAccountsCount })));
        (0, core_1.info)(`Found ${orderedSponsors.length} matching ${orderedSponsors.length === 1 ? 'sponsor' : 'sponsors'}… ${orderedSponsors.length > 0 ? '🎉' : '😢'}`);
        /**
